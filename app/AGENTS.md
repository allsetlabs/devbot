...
├── main.tsx                # Entry — wraps in InitializeForgeChunks
...
- **Shared components from `@allsetlabs/forge`** — never re-implement buttons, dialogs, inputs, etc. Import from the forge module (`forge-modules/forge`).
